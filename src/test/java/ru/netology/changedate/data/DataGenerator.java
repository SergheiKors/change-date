package ru.netology.changedate.data;
...
public class DataGenerator {
    ...
    public static String generateCity() {
        var cities = new String[]{"Майкоп", "Горно-алтайск", "Уфа", "Улан-Удэ", "Махачкала", "Магас", "Нальчик",
                ...
                "Якутск", "Владикавказ", "Казань", "Кызыл", "Ижевск", "Акабан", "Грозный", "Чебоксары",
                ...
                "Иркутск", "Калининград", "Калуга", "Кемерово", "Киров", "Кострома", "Курган", "Курс",
